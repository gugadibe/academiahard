const closeModal = document.getElementById('atvModal');
function fechaModal(){
    closeModal.classList.remove('ativo');
}

function ativaModal(){
    closeModal.classList.add('ativo');
}
...
links.forEach(link =>{
    link.addEventListener('click', easyScroll);
});
